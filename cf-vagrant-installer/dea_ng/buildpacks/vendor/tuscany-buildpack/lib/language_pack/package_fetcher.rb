...
module LanguagePack
  module PackageFetcher
    ...
    VENDOR_URL = "http://114.212.84.248:80"#https://s3.amazonaws.com/heroku-jvm-langpack-java
    ...
    def fetch_from_buildpack_cache(filename)
      puts "buildpack cache= #{buildpack_cache_dir}"
    ...
    def fetch_from_curl(filename, url)
      ...
      puts "filename=#{filename} , flag=#{flag}"
